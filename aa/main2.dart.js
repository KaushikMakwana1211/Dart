...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      if (div != null) {
        J.set$text$x(div, "Hello, Dart!!");
        t1 = div.style;
        t1.backgroundColor = "lightblue";
      } else
        A.printString('Element with id "myDiv" not found.');
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.Rti, A._FunctionParameters, A._Type, A.Null, A.StringBuffer, A.CssStyleDeclarationBase]);
...
//# sourceMappingURL=main2.dart.js.map
